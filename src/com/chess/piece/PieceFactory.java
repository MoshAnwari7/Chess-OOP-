...
public class PieceFactory {
    ...
    public static Map<Location, AbstractPiece> getPieces() {
        ...
        // rocks
        pieces.put(new Location(File.A, 1), new Rock(PieceColor.LIGHT));
        pieces.put(new Location(File.H, 1), new Rock(PieceColor.LIGHT));
        pieces.put(new Location(File.A, 8), new Rock(PieceColor.DARK));
        pieces.put(new Location(File.H, 8), new Rock(PieceColor.DARK));
        ...
        for (File file : File.values()) {
            ...
            pieces.put(new Location(file, 7), new Pawn(PieceColor.LIGHT));
        }
